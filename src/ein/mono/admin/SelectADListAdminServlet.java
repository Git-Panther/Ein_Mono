...
@WebServlet("/selectADListAdmin.do")
public class SelectADListAdminServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public SelectADListAdminServlet() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<EventVo> list = es.selectEventListAdmin(currentPage, limit);
		ArrayList<EventVo> mainEventList = es.selectMainEventList();
		
		String url = "";
		if(null != list) {
				url = "views/admin/adListAdmin.jsp";
